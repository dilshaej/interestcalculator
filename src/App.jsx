...
const handleValidaton = (tag)=>{
console.log("inside handleValidaton");
...
<form className='mt-5'>
  {/* principle */}
  <div className="mb-3">
  <TextField className='w-100' id="outlined-basic-principle" label="₹ Principle Amount" variant="outlined" value={principle || ""} name='principle' onChange={e=>handleValidaton(e.target)} />
  </div>
 { !principleAmountValid && <div className="text-danger mb-3">*Invalid Principle Amount</div>}
  {/* rate */}
  <div className="mb-3">
  <TextField className='w-100' id="outlined-basic-rate" label="Rate of Interest(p.a) %" variant="outlined" value={rate || ""} name='rate' onChange={e=>handleValidaton(e.target)} />
  </div>
  ...
  {/* time */}
  <div className="mb-3">
  <TextField className='w-100' id="outlined-basic-time" label="Time Period (Yr)" variant="outlined" value={year || ""} name='year' onChange={e=>handleValidaton(e.target)} />
  </div>
...
<Button onClick={handleReset} style={{width:'50%',height:'70px'}} variant="contained">RESET</Button>
